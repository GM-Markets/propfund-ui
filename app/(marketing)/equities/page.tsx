...
export const metadata: Metadata = { title: "Equities challenges | Propfund", description: "One-step simulated equities challenges across 1,000+ US stocks and sector ETFs." };
